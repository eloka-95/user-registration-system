...
<div style="display: flex">
    <select name="C_code" type="number" {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge(['class' => 'rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50']) !!} style="width: 50%;">
        < class="input-block-level" id="countryCode" name="countryCode">
    ...
    <input name="phone" type="tel" placeholder="Phone Number" value="" {{  $disabled ? 'disabled' : '' }} {!! $attributes->merge(['class' => 'rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50']) !!} style="width: 50%;"/>
